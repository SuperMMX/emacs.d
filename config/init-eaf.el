...
(setq eaf-webengine-font-family "H-MingLan")
(setq eaf-webengine-fixed-font-family "Hack")
(setq eaf-webengine-serif-font-family "I.MingCP")
...
(setq eaf-music-default-file "/media/Personal/Music/古琴/")
